...
Simulation::Simulation(RobotType robot, Graphics3D* window,
  ...
  } else if (_robot == RobotType::LEGBOT) {
    _quadruped = buildLegBot<double>();
  } else {
  ...
  if (_window) {
    ...
    _simRobotID = (_robot == RobotType::MINI_CHEETAH || _robot == RobotType::LEGBOT)
                                                    ? window->setupMiniCheetah(truthColor, true, true)
                                                    : window->setupCheetah3(truthColor, true, true);
    _controllerRobotID = (_robot == RobotType::MINI_CHEETAH || _robot == RobotType::LEGBOT)
  ...
  // init spine:
  if (_robot == RobotType::MINI_CHEETAH || _robot == RobotType::LEGBOT) {
